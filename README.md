...
***[Mentor: Pankaj Kapoor](https://github.com/EricAnthony5)***
...
### How to run the project 🚀:
  ...
  1. Open the `Terminal`.
  2. Clone the repository by entering `$ git clone https://github.com/EricAnthony5/React_Travel `.
  3. Ensure that `NodeJS` and `npm` are installed on the system.
  4. change the diectory to repository name using  `$ cd https://github.com/EricAnthony5/React_Travel`.
  4. Create a `.env` file and write `REACT_APP_API_URL='your backend api url'`. look for backend of the project [here](https://github.com/EricAnthony5/React_Travel-api).
